(defproject multimodal-android/multimodal-android "0.1.0-SNAPSHOT"
             ...
             [:android-common :android-user
              {:dependencies [[org.clojure/tools.nrepl "0.2.10"]]
               ...
               :android {:aot :all-with-unused
                         :manifest-options {:app-name "multimodal-wonka (debug)"}
                         ;; Uncomment to be able install debug and release side-by-side.
                         ;; :rename-manifest-package "one.gra.multimodalrouting.debug"
                         }}]
             :release
             [:android-common
  ...
  :android {;; Specify the path to the Android SDK directory.
            :sdk-path "/home/basti/Android/Sdk/"
