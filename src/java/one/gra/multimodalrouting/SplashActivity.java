package one.gra.multimodalrouting;
...
import one.gra.multimodalrouting.R;
...
public class SplashActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (firstLaunch) {
            firstLaunch = false;
            setupSplash();
            App.loadAsynchronously("one.gra.multimodalrouting.MyRouting",
                                   new Runnable() {
                                       @Override
                                       public void run() {
                                           proceed();
    ...
    public void proceed() {
        startActivity(new Intent("one.gra.multimodalrouting.MAIN"));
        finish();
    }
