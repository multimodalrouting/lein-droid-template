(ns one.gra.multimodalrouting.main
...
(defonce activity (atom {}))

;; This is how an Activity is defined. We create one and specify its onCreate
;; method. Inside we create a user interface that consists of an edit and a
;; button. We also give set callback to the button.
(defactivity one.gra.multimodalrouting.MyRouting
  :key :main

  (onCreate [this bundle]
    (.superOnCreate this bundle)
    (neko.debug/keep-screen-on this)
    (reset! activity {:activity this :context (.getApplicationContext this)})
    (on-ui
      (set-content-view! (*a)
